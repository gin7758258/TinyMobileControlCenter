...
public class DateUtil {
    ...
    public static BigDecimal getCount(Date startTime,Date endTime) {
        if(startTime!=null&&endTime!=null){
            BigDecimal t1=new BigDecimal(startTime.getTime());
            BigDecimal t2=new BigDecimal(endTime.getTime());
            BigDecimal t3=new BigDecimal(1000*60*60);
            return (t2.subtract(t1)).divide(t3, 4, BigDecimal.ROUND_HALF_UP);
        }
